...
function Test_Generic_Headless()
{
// If called from the script is called from a ``Test Execution Plan as a Local Headless Browser, a browser connection is not needed 
