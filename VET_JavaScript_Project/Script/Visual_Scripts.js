...
function Visual_Demo_2()
{
  ...
  //Evaluates the visual fidelity of user interface.
  var testRun, testRun1, testRun2, testRun3, testRun4, testRun5, testRun6, testRun7, testRun8;
  testRun = VisualTest.CreateRun("DefaultFS");
  testRun.SetAllowedFails(0);
  testRun.Capture(Aliases.browser.pageShop, "pageShop FullScreen Default", testRun.Fullpage, 0, true);
  //Evaluates the visual fidelity of user interface.
  ...
  //Evaluates the visual fidelity of user interface.
  testRun8 = VisualTest.CreateRun("RunElement");
  testRun8.SetAllowedFails(0);
  testRun8.Capture(Aliases.browser.pageShop.header.navUsd.linkLogIn, "pageShop Login Button", testRun8.Element, 0, true);
  //Clicks the 'textnodeOldsailor1960' control.
  Aliases.browser.pageShop.header.navUsd.navMenubarMyAccount.linkOldsailor1960.textnodeOldsailor1960.Click();
